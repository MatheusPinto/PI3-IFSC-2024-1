...
/*******************************TEMPO******************************************/
#define TIMING_TOTAL_DEFAULT (120 * 60 * 1000)
#define TIMING_TOTAL_MIN (30 * 60 * 1000)
#define TIMING_TOTAL_MAX (120 * 60 * 1000)
#define TIMING_TOTAL_STEP (10 * 60 * 1000)
/*******************************INTERVALO**************************************/
#define TIMING_INTERVAL_DEFAULT (4 * 60 * 1000)
#define TIMING_INTERVAL_MIN (0 * 60 * 1000)
#define TIMING_INTERVAL_MAX (9 * 60 * 1000)
#define TIMING_INTERVAL_STEP (1 * 60 * 1000)
/******************************************************************************/
#define TIMING_REFRESH (1 * 60 * 1000)
