 ...
 * 
 * v 1.0.0
 * Based on EmbedYoutube by Nitipoom Unrrom and WebView by Shunta Iketaki
 *
 * MIT Licensed.
 */
Module.register("YouTubeWebView", {
	defaults: {
		autoplay: false,
		color: "red",
		controls : true,
	...
	getDom: function () {
        ...
        wrapper.id = 'youtube-webview-wrapper';
		...
		wrapper.innerHTML = `<webview id="youtube-webview" style="display:inline-flex; width:${this.config.width}; height:${this.config.height}" src="https://www.youtube.com/embed/${videoId}&${params}" nodeIntegration ${referrer}></webview>`;
		return wrapper;
	},
