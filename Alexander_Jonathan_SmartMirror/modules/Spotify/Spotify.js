...
Module.register("Spotify", {
  ...
  defaults: {
    ...
    useExternalModal: false, // if you want to use Modal for account and device popup selection instead of the build-in one (which is restricted to the album image size)
    updateInterval: 1000,
    idleInterval: 10000,
    ...
    //iconify: null,
    //When you use this module with `CalendarExt` or any other `iconify` used modules together, Set this null.
    onStart: null,
  ...
  getStyles: function () {
    return ["Spotify.css", 'font-awesome.css']
  },
  ...
  updateCoverImage: function (imgUrl) {
    ...
    if (typeof imgUrl === "undefined") {
      imgUrl = "./modules/Spotify/resources/spotify-xxl.png"
  ...
  getCoverContainer: function () {
    ...
    cover_img.src = "./modules/Spotify/resources/spotify-xxl.png"
